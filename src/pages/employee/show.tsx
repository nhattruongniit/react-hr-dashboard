...
function EmployeeShow() {
  ...
  const dataSource = data?.data as IEmployee || {};
        ...
        <div className="mb-6 rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800">
          <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between mb-10">
            <div className="flex w-full flex-col items-center gap-6 xl:flex-row">
              <div className="h-20 w-20 overflow-hidden rounded-full border border-gray-200 dark:border-gray-800">
                <img src={dataSource.avatar ||`/images/user/user-14.jpg`} alt="User" width="100%" height="100%" />
              </div>
              <div className="order-3 xl:order-2">
                <h4 className="mb-2 text-center text-lg font-semibold text-gray-800 xl:text-left dark:text-white/90 capitalize">
                  {dataSource.last_name + ' ' + dataSource.first_name}
                </h4>
                <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    {dataSource.city}, {dataSource.country}  
                  </p>
                </div>
              </div>
              <div className="order-2 flex grow items-center gap-2 xl:order-3 xl:justify-end">
                <button className="shadow-theme-xs flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                {dayjs(dataSource.hire_date).format('DD MMM YYYY')}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                <StatusBadge status={dataSource.status.toLocaleLowerCase()}>
                  {dataSource.status}
                </StatusBadge>
              </p>
            </div>
            ...
            <div className="w-full">
              ...
              <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                   {dayjs(dataSource.date_of_birth).format('DD MMM YYYY')}
                  </p>
                </div>
